...
var _Turbopuffer_instances, _a, _Turbopuffer_encoder, _Turbopuffer_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Turbopuffer = void 0;
...
const namespaces_1 = require("./resources/namespaces.js");
...
const compress_1 = require("./internal/custom/compress.js");
...
class Turbopuffer {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('TURBOPUFFER_BASE_URL'), apiKey = (0, env_1.readEnv)('TURBOPUFFER_API_KEY'), region = (0, env_1.readEnv)('TURBOPUFFER_REGION') ?? null, defaultNamespace = null, ...opts } = {}) {
        _Turbopuffer_instances.add(this);
        _Turbopuffer_encoder.set(this, void 0);
        if (apiKey === undefined) {
            throw new Errors.TurbopufferError("The TURBOPUFFER_API_KEY environment variable is missing or empty; either provide it, or instantiate the Turbopuffer client with an apiKey option, like new Turbopuffer({ apiKey: 'tpuf_A1...' }).");
        }
        const options = {
            apiKey,
            region,
        ...
        if (hasRegionPlaceholder) {
            if (region === null) {
                throw new Errors.TurbopufferError(`region is required, but not set (baseURL has a {region} placeholder: ${baseURL})`);
            }
            baseURL = baseURL.replace('{region}', region);
        }
        else if (region !== null) {
            throw new Errors.TurbopufferError(`region is set, but would be ignored (baseURL does not contain {region} placeholder: ${baseURL})`);
        }
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('TURBOPUFFER_LOG'), "process.env['TURBOPUFFER_LOG']", this) ??
                defaultLogLevel;
        ...
        this.fetch =
            options.fetch ??
                (0, _fetch_1.makeFetch)({
                    connectTimeout: options.connectTimeout ?? 10 * 1000,
                    connectionIdleTimeout: options.idleTimeout ?? 60 * 1000,
                });
        tslib_1.__classPrivateFieldSet(this, _Turbopuffer_encoder, Opts.FallbackEncoder, "f");
     ...
     * List namespaces.
     */
    namespaces(query = {}, options) {
        return this.getAPIList('/v1/namespaces', (Pagination.NamespacePage), {
            query,
            ...options,
        });
    }
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.TurbopufferError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Turbopuffer_instances, "m", _Turbopuffer_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    async buildRequest(inputOptions, { retryCount = 0, clock } = {
        clock: {
            requestStart: 0,
        },
    }) {
        ...
        if (this.compression) {
            content = await (0, compress_1.compress)(content);
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Turbopuffer_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Turbopuffer = Turbopuffer;
_a = Turbopuffer, _Turbopuffer_encoder = new WeakMap(), _Turbopuffer_instances = new WeakSet(), _Turbopuffer_baseURLOverridden = function _Turbopuffer_baseURLOverridden() {
    return this.baseURL !== 'https://{region}.turbopuffer.com';
};
Turbopuffer.Turbopuffer = _a;
Turbopuffer.DEFAULT_TIMEOUT = 60000; // 1 minute
Turbopuffer.TurbopufferError = Errors.TurbopufferError;
Turbopuffer.APIError = Errors.APIError;
Turbopuffer.APIConnectionError = Errors.APIConnectionError;
Turbopuffer.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Turbopuffer.APIUserAbortError = Errors.APIUserAbortError;
Turbopuffer.NotFoundError = Errors.NotFoundError;
Turbopuffer.ConflictError = Errors.ConflictError;
Turbopuffer.RateLimitError = Errors.RateLimitError;
Turbopuffer.BadRequestError = Errors.BadRequestError;
Turbopuffer.AuthenticationError = Errors.AuthenticationError;
Turbopuffer.InternalServerError = Errors.InternalServerError;
Turbopuffer.PermissionDeniedError = Errors.PermissionDeniedError;
Turbopuffer.UnprocessableEntityError = Errors.UnprocessableEntityError;
Turbopuffer.toFile = Uploads.toFile;
Turbopuffer.Namespace = namespaces_1.Namespace;
